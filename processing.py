...
def plot_pie(column_name, dataframe):
    ...
    data_Attrited = dataframe[dataframe["Attrition_Flag"] == "Attrited Customer"].groupby(column_name).count().iloc[:, 0]
...
def initialize_dataframe():
    ...
    cleanup_nums = {"Education_Level": {"Unknown": 0, "Uneducated": 1, "High School": 2, "College": 3,
